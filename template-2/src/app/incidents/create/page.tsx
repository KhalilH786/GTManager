    ...
    return (
      <div className="container mx-auto p-4">
        <div className="bg-red-100 p-4 rounded-md mb-4">
          <p className="text-red-700">You must be logged in to report an incident</p>
        </div>
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      const incidentData = {
        ...
        reportedBy: user.id,
        status: "open" as "open" | "under_investigation" | "resolved",
        parentNotified,
        requiresParentNotification,
        requiresIntervention,
        intervened,
        postIncidentIntervention: postIncidentIntervention.trim() || undefined,
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <div className="p-6 border-b">
          ...
          <p className="text-gray-600">
            Please provide details about the incident. Fields marked with * are required.
          </p>
        </div>
