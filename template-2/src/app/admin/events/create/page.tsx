...
export default function CreateEventPage() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    addSchoolEvent(
      ...
      location,
      selectedTargetTypes,
      user?.id || "m1", // Use m1 (admin ID) as fallback
      targetDetails
    );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <h1 className="text-3xl font-bold">Add New School Event</h1>
        <p className="text-gray-600 mt-2">
          Create a new event for a class, grade, phase, or the whole school
        </p>
      </div>
